...
import ServidorTeste.src.*;
import ServidorTeste.src.BD.dbos.Desenho;
...
public class PedidoDeSalvamento extends Comunicado {
	...
	public PedidoDeSalvamento (String ipCliente, String dtCriacao, String dtAtualizacao, ArrayList<String> figuras)
	{
